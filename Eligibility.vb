        ...
        Do While Not rst1.EOF
            If rst1.Fields("strCnChrgDispCode").Value = "WTHCD" Then
                ...
                Else
                    ...
                    de2.ic_EligibilityRC(rst1.Fields("strCnDrlicnum").ToString, rst1.Fields("dtmCnOfnDate").ToString, intEC)
                    ' When true (inEC = 1), a recordset of relavant fields is returned.
                    If intEC = 1 Then
                        de2.ic_Eligibility(rst1.Fields("strCnDrlicnum").ToString, rst1.Fields("dtmCnOfnDate").ToString, intEC)
                    End If
                End If
                If intEC = 1 Then
...
Err_NoPrevious:
    ...
    '       Dim Report As New ReportViewer1
